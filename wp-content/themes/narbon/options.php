...
*/
	...
	$options[] = array( "name" => "اسلایدر",
						"type" => "heading");	
						
						
	$options[] = array( "name" => "دسته اسلایدر",
						"desc" => "یک دسته را برای نمایش در اسلایدر انتخاب کنید",
						"id" => "w2f_slide_categories",
						"type" => "select",
						"options" => $options_categories);						
						
	$options[] = array( "name" => "تعداد اسلایدها",
						"desc" => "تعداد اسلایدهای مورد نیاز برای نمایش در اسلایدر را انتخاب کنید",
						"id" => "w2f_slide_number",
						"std" => "",
						"type" => "text");							
